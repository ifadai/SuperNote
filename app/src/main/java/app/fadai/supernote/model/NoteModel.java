...
public class NoteModel implements INoteModel<Note> {
    ...
    public void initNote(int folderId) {
        ...
        Logger.d("time: " + time);
        Logger.d("time year: " + time + "  " + years + "  " + (time - years));
        Logger.d("time month: " + time + "  " + month + "  " + (time - month));
        Logger.d("time day: " + time + "  " + days + "  " + (time - days));


        Note note2 = new Note();
        note2.setCreatedTime(time);
        note2.setModifiedTime(time);
        ...
        Note note3 = new Note();
        note3.setCreatedTime(time);
        note3.setModifiedTime(time);
        ...
        Note note4 = new Note();
        note4.setCreatedTime(time - years);
        note4.setModifiedTime(time - years);
        ...
        Note note5 = new Note();
        note5.setCreatedTime(time - month);
        note5.setModifiedTime(time - month);
        ...
        Note note1 = new Note();
        note1.setCreatedTime(time - days);
        note1.setModifiedTime(time - days);
